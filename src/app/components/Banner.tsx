...
const Banner = () => {
    return (
        <div className="my-8 md:mx-9 md:h-[675px]" id="top">
            <div className="flex flex-col md:flex-row justify-center items-center mx-10 md:gap-16 text-center md:text-start">
                ...
                <div className="w-full md:w-1/2 relative flex flex-col ">
                    <div>
                        <Image src={Ban} alt="" className="md:w-fit md:h-[90vh]" />
